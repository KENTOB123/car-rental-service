...
const Testimonials = () => {
  return (
    <div className='flex flex-col items-center justify-center w-full mt-20 mb-20'>
            <div className='flex flex-col items-center justify-center w-2/5 gap-4 mb-10'>
            ...
            <div className='flex items-center justify-center w-3/5 gap-6 mt-16 bg-slate-200 p-10'>
                <div>
                    ...
                    <div className='flex items-center justify-around w-full mt-4'>
                        ...
                        <FormatQuoteIcon className='text-blue-700 text-6xl' />
                    </div>
                </div>
                <div>
